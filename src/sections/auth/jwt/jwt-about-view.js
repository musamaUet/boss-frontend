...
const data = [
  { label: 'License', file: 'license', image: '/assets/license.png' },
  { label: 'Insurance', file: 'COI', image: '/assets/insurance.png' },
  { label: 'Workers comp', file: 'Workers comp', image: '/assets/worker.png' },
  { label: 'Bond', file: 'Bond', image: '/assets/bond.png' },
  { label: 'Background Check', file: 'Background Check', image: '/assets/bg_check.png' },
]

export default function JwtAboutView() {
