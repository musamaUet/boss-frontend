  ...
  return (
    <>
      <Grid container spacing={2}>
        <Grid md={6}>
          <Card sx={{ p: 1.5 }}>
            <Typography textAlign={'start'} variant='h5'>Quick Stats</Typography>
            <Grid container spacing={2} mt={1}>
              {
                statsData?.map((item, index) => (
                  <Grid md={6} key={index}>
                    <Box sx={{ backgroundColor: '#f0f0f0', px: 1, py: 2 }}>
                      <Typography textAlign={'start'}>{item?.name}: {item?.value}</Typography>
                    </Box>
                  </Grid>
                ))
              }
        ...
        <Grid md={6}>
          <Card sx={{ p: 1.5, height: 1 }}>
            <Typography textAlign={'start'} variant='h5'>Recent Activities</Typography>
            <Grid container spacing={2} mt={1}>
              {
        ...
        <Grid md={12}>
          <Card sx={{ p: 1.5 }}>
            <Typography textAlign={'start'} variant='h5'>Notifications</Typography>
            <Grid container spacing={2} mt={1}>
              {
