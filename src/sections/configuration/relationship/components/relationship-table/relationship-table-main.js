...
import RelationshipTableRow from './relationship-table-row';
...
const TABLE_HEAD = [
  { id: 'organization_name', label: 'Organization Name', align: 'left' },
  { id: 'relationship_type', label: 'Relationship Type', align: 'center' },
