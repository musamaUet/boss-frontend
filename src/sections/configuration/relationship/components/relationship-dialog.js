...
const RelationshipDialog = ({ dialog, getData, selectedRow, setSelectedRow, id }) => {
  ...
  return (
    ...
    >
      ...
      <Stack alignItems={'center'} width={1}>
        <Typography variant="h4">Create New Relationship</Typography>
      </Stack>
      <Box sx={{ px: '36px', py: 5 }}>
        <FormProvider methods={methods} onSubmit={handleSubmit(onRegenerate)}>
          <Stack spacing={2.5}>
            ...
            <Box sx={{ width: '100%' }}>
              <Typography className="text-night-rider-5">Select Organization</Typography>
              <RHFSelect
                fullWidth
                size="small"
                name="organization"
            ...
            <Box sx={{ width: '100%' }}>
              <Typography className="text-night-rider-5">Relationship Type</Typography>
              <RHFSelect
                fullWidth
                size="small"
