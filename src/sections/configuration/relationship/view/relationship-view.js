  ...
  return (
    <Container maxWidth={settings.themeStretch ? false : 'xl'}>
      <Card>
        ...
        <RelationshipTable selectedPayment={selectedPayment} setSelectedPayment={setSelectedPayment} getData={getAllPayments} paymentsDialog={paymentsDialog} setSelectedRow={setSelectedRow} data={paymentTableData?.data} loading={paymentLoading} />
      </Card>

      <RelationshipDialog getData={getAllPayments} id={id} selectedRow={selectedRow} setSelectedRow={setSelectedRow} dialog={paymentsDialog} />
    </Container>
  )
}
